...
opts.onBlur.call(_4db,opts.value);
...
opts.onFocus.call(_4db,opts.value);
});
...
var _650=_651(tr),
    opts=$.data(_64e,"datagrid").options,
    tt = $(e.target),
    row = opts.finder.getRow(_64e,_650),
    td=tt.closest("td[field]",tr),
    field = td.attr('field');
if(_64c){
    if(td.length && row[field] != undefined && row[field] != '')
        td.unbind('mouseover').bind('mouseover',function(){
            opts.onHoverCell.call(_64e, _650, field, row[field],true, td)
        })
_652(_64e,_650);
}else{
    if(td.length && row[field] != undefined && row[field] != '')
        td.unbind('mouseout').bind('mouseout',function(){
            opts.onHoverCell.call(_64e, _650, field, row[field], false, td)
        })
